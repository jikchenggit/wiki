...
description: wget
published: true
date: 2021-08-23T03:40:02.632Z
tags: wget
editor: markdown
dateCreated: 2020-08-01T14:59:52.667Z
---
...
[root@localhost ~]# wget -Q 1M http://tel.mirrors.163.com/centos/6.4/isos/x86_64/CentOS-6.4-x86_64-bin-DVD1.iso    #限定最大下载字节数
...
```bash
# wget -O wordpress.zip http://192.168.1.10/abc.zip    #下载重命名
...
# wget --mirror -p --convert-links -P /root/download http://192.168.1.10/     #下载整站到本地的download文件夹

# wget -o download.log http://192.168.1.10/abc.zip  #下载信息存入日志

# wget -r -A.pdf http://192.168.1.10/  #下载指定格式文件
